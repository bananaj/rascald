...
<div id="mainNavigation"><a href="/page/projectpage/home/${(model['project'].id)!''}">Project: ${(project.name)!''}</a></div>
...
<div id="mainBody">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4"><a href="/page/projectpage/home/${(model['project'].id)!''}">${(project.name)!''}</a></div>
        </div>
        <div class="row">
...
$(document).ready(function () {
    $.get("/tcm/execution/testcase/execute/${(testCase.id)!''}/steps", function(data) {
...
function saveExecuteStep() {
    alert($('#formExecuteStep').serialize());
}
</script>
